...
const modeSwitch = (theme: string) => {
  if (theme === 'auto') {
    return <><IconCircleHalf2 size={ICON_SIZE} /></>
  } else if (theme === 'dark') {
    return <><IconMoonStars size={ICON_SIZE} /></>
  } else {
    return <><IconSunHigh size={ICON_SIZE} /></>
  }
}
